...
public class TypeModelsListener extends Observable implements Listener<String> {

    private static final String LOG_TAG = "TypeModelsListener";
    private List<Car> mCarList=null;

    public TypeModelsListener() {
