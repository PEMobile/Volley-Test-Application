 ...
 *
 * The simple way to use this class is to call {@link android.volley.toolbox.ImageLoader#get(String, android.volley.toolbox.ImageLoader.ImageListener)}
 * and to pass in the default image listener provided by
 * {@link android.volley.toolbox.ImageLoader#getImageListener(android.widget.ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
     ...
     * If the default was returned, the {@link android.volley.toolbox.ImageLoader} will be invoked when the
